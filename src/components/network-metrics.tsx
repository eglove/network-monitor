            ...
            <Table aria-label="Network Metrics" classNames={{table: "table-fixed w-96"}}
                   bottomContent={
                       <div className="grid place-content-end">
                           <Button className="w-max" size="sm" color="danger" onPress={() => {
                               setMetrics([])
                           }}>Clear</Button>
                       </div>
                   }>
                ...
                <TableBody>
                    <TableRow key="1" className="text-blue-300">
                        ...
                        <TableCell>{mbpsFormatter.format(Number.isNaN(averageRx) ? 0 : averageRx)}</TableCell>
                    ...
                    <TableRow key="2" className="text-rose-300">
                        ...
                        <TableCell>{mbpsFormatter.format(Number.isNaN(averageTx) ? 0 : averageTx)}</TableCell>
